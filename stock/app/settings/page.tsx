  ...
  return (
    <div className="space-y-10">
      ...
      <section>
        ...
        <p className="mb-4 text-xs text-zinc-500">
          /performance 權益曲線的起點,也是報酬率的<b>分母</b>。**單位:萬 NT$**
          (輸 20.3004 = NT$ 203,004)。
          <span className="text-zinc-600">
            {" "}<b>加碼入金後要把金額加進這個數字</b> —— 不加的話 /performance 會把現金
            算成負數並拒絕顯示報酬率(該頁的警告會直接告訴你至少要設到多少)。
            代價是入金會被視同「從第一天就在帳戶裡」,早期報酬率因此略為低估。
          </span>
        </p>
        {capitalSetting ? (
